#include "DefenseStrategy.hpp"  //cstdlib esta incluida aqui

int main(){
    std::vector<tipoCelda> Vf, Vr;

    //Llenamos los vectores con números aleatorios (Los mismos)
    for(int i = 0; i < 100; i++){
        int r = rand();
    ...
    std::cout << "FUSIÓN - 100 elementos aleatorios: ";
    bool success = true;
    ...
    std::cout << "RÁPIDA - 100 elementos aleatorios: ";
    success = true;
    for(int i = 1; i < 100 && success; i++){
